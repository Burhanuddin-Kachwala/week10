...
<head>
    <meta charset="UTF-8">
    <title>Order Dilivered - BookSaw</title>
    ...
    <div class="max-w-2xl mx-auto p-8">
        <div class="bg-white shadow-md rounded-lg">
            <div class="bg-blue-600  p-6 text-center">
                <h1 class="text-2xl font-bold text-gray-800">Your Order Has Been Dilivered! 📭</h1>
            </div>

            <div class="p-6">
                <p>Hello {{ $order->user->name }},</p>
                <p>Your order #{{ $order->id }} has been dilivered successfully!</p>
                ...
                <!-- Shipping Address -->
                <h2 class="text-xl font-semibold mt-6">Dilivery Address</h2>
                @php
